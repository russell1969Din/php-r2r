...
<?
                ...
                if(strLen(Trim($oVideo["con_videoName"])) > 0) {$videoName = $oVideo["con_videoName"];} else {$videoName = "djkfsldkfjsd";}
        ...
        switch($iFrame) {
                case 0: { 
?>
                <div id="mediaDesk" class="container mt-5 d-flex justify-content-center"></div>
<?      
                break; }
...
<?
        ...
        if(strLen(Trim($sourceVideo))==1)  {
?>
        <div id="mediaDesk" class="container mt-5 d-flex justify-content-center">
        </div>
<?      
        }
